...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['527px','245px','85px','85px','auto','auto'],
   ...
   },
   {
      ...
      type:'image',
      tag:'img',
      rect:['332px','111px','127px','432px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/intro_host.png','0px','0px']
   },
   {
      id:'Text',
      type:'text',
      rect:['527px','340px','auto','auto','auto','auto'],
      text:"LOADING",
      font:['Arial, Helvetica, sans-serif',19,"rgba(0,0,0,1)","normal","none",""]
   }]};//simpleContent
...
dlContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['0','0','960px','670px','auto','auto'],
